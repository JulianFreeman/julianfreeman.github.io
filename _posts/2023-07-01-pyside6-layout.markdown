...
tags: [python, gui, layout]
description: 本文简单介绍一点 PySide6 的界面布局  # Add post description (optional)
img: pyside6-layout.jpg  # Add image post (optional)
---
# 目录

- [自己的 UI 类](#自己的-ui-类)
- [主窗口的菜单、工具栏和状态栏](#主窗口的菜单工具栏和状态栏)
- [关于布局](#关于布局)
...
封面图：Photo by [Hal Gatewood][cover-img-author] on [Unsplash][cover-img-src]


[cover-img-author]: https://unsplash.com/@halacious?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText
[cover-img-src]: https://unsplash.com/photos/weRQAu9TA-A?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText
