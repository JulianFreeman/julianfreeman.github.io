---
layout: post
title: Google Sheet 公式笔记 - 去重
date: 2023-05-22 21:06:00 -0400
tags: [google sheet, formula]
description: 本文介绍数组去重 # Add post description (optional)
img: gsf7-de-duplicate.jpg  # Add image post (optional)
---
...
封面图：Photo by [A n v e s h][cover-img-author] on [Unsplash][cover-img-src]


[cover-img-author]: https://unsplash.com/@anvesh1616?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText
[cover-img-src]: https://unsplash.com/photos/T1hpoYJu1bU?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText
