...
tags: [python, gui, modelview]
description: 本文简单介绍一点 PySide6 的模型视图  # Add post description (optional)
img: pyside6-modelview.jpg  # Add image post (optional)
---
# 目录

- [模型视图](#模型视图)
- [Delegate 初步](#delegate-初步)
...
![Untitled]({{site.baseurl}}/assets/img/pyside6-modelview/three-models.png)
...
封面图：Photo by [Jasper Mendoza][cover-img-author] on [Unsplash][cover-img-src]


[cover-img-author]: https://unsplash.com/@jas_creatives?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText
[cover-img-src]: https://unsplash.com/photos/9epdlhPGA4I?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText
