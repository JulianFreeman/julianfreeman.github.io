---
layout: post
title: Google Sheet 公式笔记 - 比较空
date: 2023-05-22 22:36:00 -0400
tags: [google sheet, formula]
description: 本文介绍比较空值和查找非空值 # Add post description (optional)
img: gsf8-comp-null.jpg  # Add image post (optional)
---
...
封面图：Photo by [Ben Hershey][cover-img-author] on [Unsplash][cover-img-src]


[cover-img-author]: https://unsplash.com/@benhershey?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText
[cover-img-src]: https://unsplash.com/photos/1IZBAlIs4ug?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText
