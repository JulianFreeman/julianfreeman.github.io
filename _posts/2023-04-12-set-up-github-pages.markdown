...
tags: [github, web]
description: 免折腾创建 Github Pages 个人站点的简单步骤 # Add post description (optional)
img: set-up-github-pages.jpg  # Add image post (optional)
---
## TL;DR
...
这种类型的模板一般文件结构有 `_layout`、`_post` 之类的文件夹，前者会有各种 html 模板文件，后者则放着所有的帖子，都是 Markdown 文件，文件命名是 `YYYY-MM-DD-post-name.markdown` 这种的。
...
[cover-img-author]: https://unsplash.com/@rubaitulazad?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText
[cover-img-src]: https://unsplash.com/photos/HLQDfaJUTVI?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText
