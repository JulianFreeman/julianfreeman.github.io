...
img: program-c-contents.jpg  # Add image post (optional)
---
...
1. [void 作为参数](#1-void-作为参数)
2. [查看整数类型的最大最小值](#2-查看整数类型的最大最小值)
3. [关于字符串](#3-关于字符串)
4. [变量是什么？](#4-变量是什么)
5. [补充字符串的创建以及延申打印的规则](#5-补充字符串的创建以及延申打印的规则)
6. [const 到底是啥？](#6-const-到底是啥)
7. [const 的进阶](#7-const-的进阶)
8. [数组指针受限情况的简单说明](#8-数组指针受限情况的简单说明)
...
参考文档：[C 和 C++ 整数限制][c-cpp-int-limits]
...
封面图：Photo by [Maksym Zakharyak][cover-img-author] on [Unsplash][cover-img-src]

[c-cpp-int-limits]: https://learn.microsoft.com/zh-cn/cpp/c-language/cpp-integer-limits?view=msvc-170

[cover-img-author]: https://unsplash.com/@zakharyak?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText
[cover-img-src]: https://unsplash.com/photos/WsL5PhqlGaU?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText
