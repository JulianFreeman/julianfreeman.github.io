...
description: 记录日常遇到的各种关于声音的疑难杂症 # Add post description (optional)
img: voice-problems.jpg  # Add image post (optional)
---
## 回环阻断
...
![sim-block-1]({{site.baseurl}}/assets/img/voice-problems/sim-block-1.png)
...
封面图：Photo by [Pawel Czerwinski][cover-img-author] on [Unsplash][cover-img-src]

[cover-img-author]: https://unsplash.com/@pawel_czerwinski?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText
[cover-img-src]: https://unsplash.com/photos/eybM9n4yrpE?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText
